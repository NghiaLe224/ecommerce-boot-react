...
const SetQuantity = ({cardCounter, quantity, handeQtyIncrease, handleQtyDecrease }) => {
  return (
    // <div className="flex items-center gap-3">
    //   <button onClick={handleQtyDecrease} disabled={quantity <= 1}>-</button>
    //   <span>{quantity}</span>
    //   <button onClick={handeQtyIncrease}>+</button>
    // </div>
